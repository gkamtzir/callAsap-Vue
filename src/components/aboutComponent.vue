<template>
    <div>
        <div class="container">
            ...
            <p>
                Here in <b>CallAsap</b>, we have gathered Europe's emergency phone numbers with reliability and precision.
                All information can be intuitively and quickly accessed via the "Search" option.
            </p>
            <p>
                We have also designed our own API from scratch, which is publicly available <a href="http://gkamtzir.webpages.auth.gr/api">here</a> and can be freely used.
            </p>
            <br />
            <p class="feedback">
                <b>For every question or comment you may have, you can reach us at: georgekam96@gmail.com</b>
            </p>
